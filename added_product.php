...
&& in_array($extension, $allowedExts))
  ...
  if ($_FILES["image"]["error"] > 0)
    ...
    if (file_exists("products/" . $_FILES["image"]["name"]))
      ...
      {
	  	$insert=mysql_query("insert into products set name='$name',price='$price',quantity='$quan',seller='$seller',info='$info',discount='$discount',category='$category'") or die("cannot insert");
		$pid=mysql_insert_id();
		$photo=$pid.".".$extension;
